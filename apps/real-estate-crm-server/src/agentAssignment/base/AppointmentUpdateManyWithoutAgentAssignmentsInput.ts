...
@InputType()
class AppointmentUpdateManyWithoutAgentAssignmentsInput {
...
export { AppointmentUpdateManyWithoutAgentAssignmentsInput as AppointmentUpdateManyWithoutAgentAssignmentsInput };
