...
@InputType()
class AppointmentCreateNestedManyWithoutAgentAssignmentsInput {
...
export { AppointmentCreateNestedManyWithoutAgentAssignmentsInput as AppointmentCreateNestedManyWithoutAgentAssignmentsInput };
